                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-3">
                            <button class="btn btn-block bg-dark" type="submit"><i class="fas fa-barcode"></i>Cari By Barcode</button>
                            </form>
                        </div>
                        <div class="form-group col-sm-3">
                            <button class="btn btn-block bg-green" type="button" data-toggle="modal" data-target="#cariProduk" ><i class="fas fa-tags"></i>Cari By Nama</button>
                        </div>
                    </div>
                    ...
                    <button class="btn btn-block bg-blue mt-3" data-toggle="modal" data-target="#simpanJual"><i class="fas fa-save"></i>Simpan Penjualan</button>
                </div>
            </div>
    </section>
    <!-- /.content -->
            ...
            <table id="example1" class="table table-hover">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><form action="aksi/penjualan.php" method="post">
                                    <input type="hidden" name="aksi" value="tambah-keranjang-bynama">
                                    <input type="hidden" name="ProdukID" value="<?= $kolom['ProdukID']; ?>">
                                    <input type="number" name="Jumlah" class="form-comtrol" value="1">
                                </td>
                                <td>
                                    <button class="btn bg-green" type="submit"><i  class="fas fa-check">Pilih</i></button>
                                </form>
                                </td>
                            </tr>
                            <?php } ?>
...
<div class="modal fade" id="simpanJual" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">9*
        <div class="modal-content">
            <div class="modal-header">
            ...
            <input type="date" name="TanggalPenjualan" class="form-control" value="<?= date('Y-m-d'); ?>" requaried>

            <label for="TotalHarga">Tota Belanja</label>
